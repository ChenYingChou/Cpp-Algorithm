...
const int MASKS = 0333333333;   // Octal
...
static int twist[10][2] = {
        ...
        {     0  , 0000110110 }, // 3:BCEF
        {     0  , 0001001001 }, // 4:ADG
        { M3('A'), 0010111010 }, // 5:BDEFH -> A must be ready
        { M3('B'), 0100100100 }, // 6:CFI   -> B must be ready
        { M3('C'), 0011011000 }, // 7:DEGH  -> C must be ready
        { M3('D'), 0111000000 }, // 8:GHI   -> D must be ready
        { M3('G'), 0110110000 }  // 9:EFHI  -> G must be ready
    };
